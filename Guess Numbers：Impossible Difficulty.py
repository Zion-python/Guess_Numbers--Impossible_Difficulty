...
def play_game():
    ...
    while chance != 0:
        ...
        if player_guess.lower() == "change mode":
            ...
            lowest_number = 0
            chance = 14 - random.randint(2, 3) * int(difficulty_mode)
            random_number = (highest_number - lowest_number + 1)
        ...
        if guess == random_number:
            ...
            if difficulty_mode == "1":
                ...
                chance = max(random.randint(10,12), int(range_size ** 0.35) + level)
                ...
                range_size = highest_number - lowest_number + 1
                chance = max(random.randint(8,11), int(range_size ** 0.3) + level)
                ...
                range_size = highest_number - lowest_number + 1
                chance = max(random.randint(7,9), int(range_size ** 0.25) + level // 2)
                ...
                range_size = highest_number - lowest_number + 1
                chance = max(random.randint(5,7), int(range_size ** 0.2) + level // 3)
