    ...
    while chance != 0:
        ...
        if guess == random_number:
            ...
            if difficulty_mode in ["1","Easy","easy"]:
                ...
                chance = int(chance * 0.8 +  (max(random.choice([5, 8]) + level,int((highest_number - lowest_number + 1) ** 0.5) + level // 2)))
                ...
                chance = int(chance * 0.7 +  (max(random.choice([4, 6]) * level, int((highest_number - lowest_number + 1) ** 0.4) + level // 2)))
                ...
                chance = int(chance * 0.6 +  (max(random.choice([3, 5]) * level,int((highest_number - lowest_number + 1) ** 0.3) + level // 2)))
            else :
                highest_number = int(highest_number * (3.0 + level * 0.5))
                lowest_number = lowest_number - random.randint(0, max(1, int(highest_number * 0.4)))
                chance = int(chance * 0.5 + (max(random.choice([3, 4]) * level,(highest_number - lowest_number + 1) ** 0.25 + level // 3)))
            time.sleep(0.25)
